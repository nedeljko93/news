...
import { loadData, countryHasChanged } from '../redux/Actions'
...
class CategoriesScreen extends Component {
    componentDidMount() {
        this.props.isUS ? this.props.loadData(US, true) : this.props.loadData(GB, true)
    }
...
export default connect(mapStateToProps, { loadData, countryHasChanged })(CategoriesScreen);