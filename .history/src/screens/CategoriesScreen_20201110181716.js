...
class CategoriesScreen extends Component {
    state = {
        isEntertainmentCategoryEmpty: true,
    }
    componentDidMount() {
    ...
    render() {
        if (this.props.list.entertainmentList.lenght != 0) {
            this.setState({ isEntertainmentCategoryEmpty: false })
        }
        return (
            <View>
                <CardSection>
                ...
                <ScrollView>
                    {this.state.isEntertainmentCategoryEmpty &&
                        <CardSection>
                            <CategoriesList
                                name="Entertainment"
